(async function () {
  ...
  const twentyFour = {
    ...
    "1, 1, 8, 8": ["(1+1)*8+8", "8+(1+1)*8", "8+8*(1+1)", "8*(1+1)+8"],
    "1, 1, 6, 9": ["6+(1+1)*9", "(1+1)*9+6", "6+9*(1+1)", "9*(1+1)+6"],
    "1, 1, 2, 7": [
      "(1+2)*(1+7)",
      "(7+1)*(1+2)",
      "(2+1)*(7+1)",
    ...
    "1, 1, 2, 9": ["(9-1)*(2+1)", "(9-1)*(1+2)", "(2+1)*(9-1)", "(1+2)*(9-1)"],
    "1, 2, 2, 9": [
      "(2+9+1)*2",
      "2*(1+9+2)",
      "2*(2+1+9)",
    ...
    "1, 1, 4, 9": ["(4-1)*(9-1)", "(9-1)*(4-1)", "(1-4)*(1-9)", "(1-9)*(1-4)"],
    "1, 4, 4, 4": [
      "4+4*(4+1)",
      "4*(4+1)+4",
      "(4+4)*(4-1)",
    ...
    "1, 5, 5, 9": ["(9-5)*(1+5)", "(5+1)*(9-5)", "(9-5)*(5+1)", "(1+5)*(9-5)"],
    "1, 5, 9, 9": [
      "9+9+5+1",
      "5+9+9+1",
      "9+1+5+9",
    ...
    "1, 3, 7, 7": ["(1-7)*(3-7)", "(7-1)*(7-3)", "(3-7)*(1-7)", "(7-3)*(7-1)"],
    "1, 3, 7, 9": [
      "9*(7+1)/3",
      "(7+1)/(3/9)",
      "(7+1)*9/3",
    ...
    "1, 5, 7, 9": ["(7-1)*(9-5)", "(1-7)*(5-9)", "(9-5)*(7-1)", "(5-9)*(1-7)"],
    "1, 4, 7, 7": ["(7+1)*(7-4)", "(7-4)*(1+7)", "(1+7)*(7-4)", "(7-4)*(7+1)"],
    "1, 7, 7, 9": [
      "1+9+7+7",
      "9+7+1+7",
      "7+9+1+7",
    ...
    "1, 6, 7, 9": ["(9-6)*(7+1)", "(7+1)*(9-6)", "(1+7)*(9-6)", "(9-6)*(1+7)"],
    "1, 3, 3, 8": [
      "3+3*(8-1)",
      "3-(1-8)*3",
      "3-3*(1-8)",
    ...
    "1, 4, 7, 9": ["(4-7)*(1-9)", "(9-1)*(7-4)", "(1-9)*(4-7)", "(7-4)*(9-1)"],
    "1, 5, 8, 9": [
      "(9-(1+5))*8",
      "(9-1)*(8-5)",
      "8*(9-1-5)",
    ...
    "2, 2, 2, 7": ["(7*2-2)*2", "(2*7-2)*2", "2*(2*7-2)", "2*(7*2-2)"],
    "2, 2, 6, 7": [
      "2*(6+7)-2",
      "(7+2)*2+6",
      "(7+6)*2-2",
    ...
    "2, 2, 3, 5": ["3*(5*2-2)", "(2*5-2)*3", "3*(2*5-2)", "(5*2-2)*3"],
    "2, 2, 5, 7": [
      "2*7+2*5",
      "2*5+2*7",
      "5*2+7*2",
    ...
    "2, 4, 5, 5": ["4+2*(5+5)", "4+(5+5)*2", "2*(5+5)+4", "(5+5)*2+4"],
    "2, 5, 5, 8": ["8*(5/5+2)", "8*(2+5/5)", "(2+5/5)*8", "(5/5+2)*8"],
    "2, 5, 5, 9": [
      "5+9+2*5",
      "2*5+9+5",
      "9+(5-2)*5",
    ...
    "2, 5, 7, 8": ["(2*5-7)*8", "8*(2*5-7)", "8*(5*2-7)", "(5*2-7)*8"],
    "2, 2, 5, 8": ["(5+8)*2-2", "(8+5)*2-2", "2*(8+5)-2", "2*(5+8)-2"],
    "2, 5, 8, 9": [
      "9+5+2+8",
      "8+2+5+9",
      "5+9+2+8",
    ...
    "2, 7, 8, 9": ["(9+7)*2-8", "2*(7+9)-8", "2*(9+7)-8", "(7+9)*2-8"],
    "1, 2, 8, 9": [
      "8-2*(1-9)",
      "9/((2+1)/8)",
      "9/((1+2)/8)",
    ...
    "3, 3, 3, 5": ["3*3+5*3", "3*3+3*5", "5*3+3*3", "3*5+3*3"],
    "3, 3, 3, 6": [
      "6+3*(3+3)",
      "(3+3)*3+6",
      "3*(6+3)-3",
    ...
    "3, 3, 5, 7": ["(5*3-7)*3", "(3*5-7)*3", "3*(3*5-7)", "3*(5*3-7)"],
    "3, 3, 6, 7": [
      "7*3+6-3",
      "3*(7+3)-6",
      "3-7*(3-6)",
    ...
    "3, 3, 7, 7": ["7*(3/7+3)", "(3+3/7)*7", "(3/7+3)*7", "7*(3+3/7)"],
    "3, 3, 7, 8": [
      "8+3*3+7",
      "7+8+3*3",
      "3*3+8+7",
    ...
    "3, 4, 4, 4": ["4*(3+4)-4", "(4+3)*4-4", "4*(4+3)-4", "(3+4)*4-4"],
    "3, 4, 4, 5": [
      "5+3+4*4",
      "4*(4-3+5)",
      "4*(5-(3-4))",
    ...
    "3, 3, 6, 6": ["3*(6+6/3)", "3*(6/3+6)", "(6/3+6)*3", "(6+6/3)*3"],
    "3, 5, 6, 7": [
      "(7+5)/3*6",
      "3*(7-(5-6))",
      "6*(5+7)/3",
    ...
    "4, 4, 4, 5": ["4*(5+4/4)", "(5+4/4)*4", "4*(4/4+5)", "(4/4+5)*4"],
    "4, 4, 4, 6": [
      "6*(4+4-4)",
      "4-4+6*4",
      "4/(4/6)*4",
    ...
    "4, 4, 4, 7": ["4*(7-4/4)", "(7-4)*(4+4)", "(4+4)*(7-4)", "(7-4/4)*4"],
    "4, 4, 7, 7": ["7*(4-4/7)", "(4-4/7)*7"],
    "4, 4, 7, 8": [
      "4-(8-4*7)",
      "4+7*4-8",
      "7*4+4-8",
    ...
    "4, 5, 9, 9": ["4*(9/9+5)", "(9/9+5)*4", "4*(5+9/9)", "(5+9/9)*4"],
    "4, 6, 6, 6": [
      "(6+6-6)*4",
      "6+6*4-6",
      "4*6-(6-6)",
    ...
    "4, 8, 9, 9": ["(4-9/9)*8", "8*(4-9/9)"],
    "1, 1, 5, 8": ["8*(5-1-1)", "(5-1-1)*8", "8*(5-(1+1))", "(5-(1+1))*8"],
    ...
    "5, 5, 5, 9": ["5+5+9+5", "9+5+5+5", "5+9+5+5", "5+5+5+9"],
    "5, 5, 6, 6": [
      "(5-(6-5))*6",
      "(6-6/5)*5",
      "5*5-6/6",
    ...
    "5, 7, 7, 9": ["(7+5)*(9-7)", "(9-7)*(7+5)", "(5+7)*(9-7)", "(9-7)*(5+7)"],
    "5, 7, 8, 9": [
      "(5+7-9)*8",
      "5*8-9-7",
      "(5-9+7)*8",
    ...
    "5, 6, 6, 9": ["6*9-5*6", "9*6-6*5", "6*9-6*5", "9*6-5*6"],
    "1, 7, 9, 9": [
      "9-(1-9)+7",
      "7+9-(1-9)",
      "7+9+9-1",
...
`;
      ...
      } else if (pureMessage.trim().toLowerCase().startsWith("/love")) {
        const userMessageRef = push(messagesRef);
        await update(userMessageRef, {
          User: email,
          Message: message,
          ...
          try {
            ...
            if (sortedScores.length === 0) {
              ...
              sortedScores.slice(0, 10).forEach((entry, index) => {
                pushMessage(
                  `${index + 1}. ${entry.email.replace(/\*/g, ".")}: ${entry.score}`,
                );
              });
            }
          } catch (error) {
